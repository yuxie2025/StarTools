...
!function(e, r) {
    ...
    t.prototype = {
            ...
            if (this.typeNumber < 1) {
                ...
                for (t = 1; t < 40; t++) {
                    ...
                    for (a = 0; a < this.dataList.length; a++) {
                        ...
                        r.put(u.mode, 4), r.put(u.getLength(), h.getLengthInBits(u.mode, t)), u.write(r);
                    }
        ...
        setupPositionAdjustPattern: function() {
            for (var t = h.getPatternPosition(this.typeNumber), e = 0; e < t.length; e++) for (var r = 0; r < t.length; r++) {
                var o = t[e], n = t[r];
        ...
        setupTypeInfo: function(t, e) {
            for (var r = this.errorCorrectLevel << 3 | e, o = h.getBCHTypeInfo(r), n = 0; n < 15; n++) {
                i = !t && 1 == (o >> n & 1);
        ...
        mapData: function(t, e) {
            for (var r = -1, o = this.moduleCount - 1, n = 7, i = 0, a = this.moduleCount - 1; a > 0; a -= 2) for (6 == a && a--; ;) {
                for (var u = 0; u < 2; u++) if (null == this.modules[o][a - u]) {
                    var s = !1;
                    i < t.length && (s = 1 == (t[i] >>> n & 1)), h.getMask(e, o, a - u) && (s = !s), 
        ...
        for (var a = o.getRSBlocks(t, r), u = new n(), s = 0; s < i.length; s++) {
            var f = i[s];
            u.put(f.mode, 4), u.put(f.getLength(), h.getLengthInBits(f.mode, t)), f.write(u);
        }
        ...
        for (;;) {
            if (u.getLengthInBits() >= 8 * l) break;
            if (u.put(e.PAD0, 8), u.getLengthInBits() >= 8 * l) break;
            u.put(e.PAD1, 8);
        }
        return e.createBytes(u, a);
    }, e.createBytes = function(t, e) {
        for (var o = 0, n = 0, i = 0, a = new Array(e.length), u = new Array(e.length), s = 0; s < e.length; s++) {
            var f = e[s].dataCount, l = e[s].totalCount - f;
            n = Math.max(n, f), i = Math.max(i, l), a[s] = new Array(f);
            for (v = 0; v < a[s].length; v++) a[s][v] = 255 & t.buffer[v + o];
            o += f;
            var g = h.getErrorCorrectPolynomial(l), c = new r(a[s], g.getLength() - 1).mod(g);
        ...
        for (var C = new Array(m), E = 0, v = 0; v < n; v++) for (s = 0; s < e.length; s++) v < a[s].length && (C[E++] = a[s][v]);
        for (v = 0; v < i; v++) for (s = 0; s < e.length; s++) v < u[s].length && (C[E++] = u[s][v]);
        return C;
    };
    for (var a = {
        MODE_NUMBER: 1,
        ...
        getErrorCorrectPolynomial: function(t) {
            for (var e = new r([ 1 ], 0), o = 0; o < t; o++) e = e.multiply(new r([ 1, f.gexp(o) ], 0));
            return e;
        },
    ...
    return r.prototype = {
        ...
        multiply: function(t) {
            for (var e = new Array(this.getLength() + t.getLength() - 1), o = 0; o < this.getLength(); o++) for (var n = 0; n < t.getLength(); n++) e[o + n] ^= f.gexp(f.glog(this.get(o)) + f.glog(t.get(n)));
            return new r(e, 0);
        },
        mod: function(t) {
            if (this.getLength() - t.getLength() < 0) return this;
            for (var e = f.glog(this.get(0)) - f.glog(t.get(0)), o = new Array(this.getLength()), n = 0; n < this.getLength(); n++) o[n] = this.get(n);
            for (n = 0; n < t.getLength(); n++) o[n] ^= f.gexp(f.glog(t.get(n)) + e);
    ...
    o.getRSBlocks = function(t, e) {
        ...
        for (var n = r.length / 3, i = new Array(), a = 0; a < n; a++) for (var u = r[3 * a + 0], s = r[3 * a + 1], h = r[3 * a + 2], f = 0; f < u; f++) i.push(new o(s, h));
        return i;
        ...
        t = t || {}, (t = Object.assign({
            ...
            r.addData(i(t.text)), r.make();
            for (var o = t._this ? wx.createCanvasContext && wx.createCanvasContext(t.canvasId, t._this) : wx.createCanvasContext && wx.createCanvasContext(t.canvasId), n = t.width / r.getModuleCount(), a = t.height / r.getModuleCount(), u = 0; u < r.getModuleCount(); u++) for (var s = 0; s < r.getModuleCount(); s++) {
                var h = r.isDark(u, s) ? t.foreground : t.background;
                o.setFillStyle(h);
                var f = Math.ceil((s + 1) * n) - Math.floor(s * n), l = Math.ceil((u + 1) * n) - Math.floor(u * n);
                o.fillRect(Math.round(s * n), Math.round(u * a), f, l);
            }
            o.draw(!1, function(e) {
